...
contract TokenBankV2 is ITokenRecipient{

    MyERC20V2 public myERC20;
     // 用来记录每个地址的存款余额
    ...
    constructor(address _tokenAddress){
        // 将传入的合约地址转换成 BaseERC20 实例
         myERC20 = MyERC20V2(_tokenAddress);  
    }
    ...
    function tokensReceived(address from, uint256 amount) external override returns (bool){
        require(msg.sender == address(myERC20), "TokenBankV2: invalid token");
